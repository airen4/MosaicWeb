...
<body>
	...
	<div id="reply" class="panle panel-info">
		<div class="panel-heading">
			<button id="replylist" class="btn btn-success">댓글 조회</button>
		</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<span class="close" data-dismiss="modal"><i class="fa fa-times-circle"></i></span>
...
<script id="mytemplate" type="text/x-handlebars-template">
	<ul class="list-group">
		...
		<li class="list-group-item">
			...
			<button class="btn btn-warning modify" data-rno="{{rno}}" 
												   data-bno="{{bno}}"
...
// 			for (var i = pageMaker.startPage; i <= 10; i++) {
		...
		function getPage(page) {
			...
			$.getJSON("/replies/1/" + page + "?xxx = " + new Date().getTime(),
					function(result) {
						console.dir(result);
				...
				function() {
					...
					var options = {
						...
						success : function(result) {
							console.log(result);
							if (result == "SUCCESS") {
								// 						self.location = "/sboard/readPage?bno=1"; //성공하면 확인을 위해 이동
							}
							// 					alert("result = " + result);
						}
					};
